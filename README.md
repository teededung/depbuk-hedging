...
> **⚠️ This project is for DeFi learning only. Run on `localhost` — do not deploy to a public server or your private keys may be exposed. Use at your own risk; the author assumes no liability for any losses.**
